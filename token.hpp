...
enum Symbol {
    ...
    TK_LT, TK_GT, TK_LTE, TK_GTE, TK_EQU, TK_NEQ, TK_NOT, TK_AND, TK_OR, TK_BLESS,
    TK_PERIOD, TK_COMA, TK_SEMI, TK_COLON, TK_AMPER, TK_LAMBDA, TK_RANGE,
...
string symbolStr[] = {
    ...
    "TK_ASSIGN", "TK_QUOTE", "TK_FUNC", "TK_PRODUCES", "TK_STRUCT", "TK_NEW", "TK_FREE",
    "TK_LET", "TK_VAR", "TK_REF", "TK_PRINT", "TK_PRINTLN", "TK_WHILE", "TK_RETURN", "TK_IF", "TK_ELSE",
    "TK_PUSH", "TK_APPEND", "TK_EMPTY", "TK_SIZE", "TK_FIRST", "TK_REST", "TK_MAP", "TK_FILTER", "TK_REDUCE", "TK_SORT", "TK_PIPE", "TK_MATCHRE",
    "TK_ERR", "TK_EOI"
};
